...
import { pipeObservable } from '../observable/helpers/piping/pipe-observable/pipe-observable';
import { mapObservablePipe } from '../observable/pipes/built-in/without-notifications/observer-pipe-related/map/map-observable-pipe';
import {
    ...
    get: (target: any, propertyKey: PropertyKey): any => {
      ...
      if (propertyKey === '$') {
        if (cachedSubscribe === void 0) {
          cachedSubscribe = pipeObservable(data, [
            mapObservablePipe<GData, any>((data: GData): any => {
        ...
        if (cachedSubscribeArray === void 0) {
          cachedSubscribeArray = pipeObservable(data, [
            mapObservablePipe<GData, any>((data: GData): any => {
